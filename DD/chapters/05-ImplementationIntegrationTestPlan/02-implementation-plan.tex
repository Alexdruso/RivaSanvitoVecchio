...
%The order of importance of a component is defined by the number of components that rely on it: the higher it is, the higher is the priority of such component.
