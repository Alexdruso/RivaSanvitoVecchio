...
\subsection{User interfaces}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=0.25\textwidth]{mockups_01.png}
    \caption{The welcome page.}
  \end{figure}

  \begin{figure}[h!]
    \centering
    \includegraphics[width=0.25\textwidth]{mockups_02.png}
    \caption{The stores map.}
  \end{figure}

  \begin{figure}[h!]
    \centering
    \includegraphics[width=0.25\textwidth]{mockups_03.png}
    \caption{The booking function.}
  \end{figure}

  \begin{figure}[h!]
    \centering
    \includegraphics[width=0.25\textwidth]{mockups_04.png}
    \caption{The line up receipt.}
  \end{figure}

  \begin{figure}[h!]
    \centering
    \includegraphics[width=0.25\textwidth]{mockups_05.png}
