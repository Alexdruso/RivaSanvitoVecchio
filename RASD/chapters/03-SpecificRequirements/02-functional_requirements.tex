...
\begin{document}
    ...
    \subsection{Use cases and sequence diagrams}
      ...
      \subsubsection{Alternative suggestion}
      ...
      \subsubsection{Visit time and place estimation}
      ...
      \subsubsection{Queueing via telephone}
      ...
      \subsubsection{Reservation via telephone}
